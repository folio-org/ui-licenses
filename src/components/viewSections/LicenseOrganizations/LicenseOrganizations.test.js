...
describe('LicenseOrganizations', () => {
  ...
  describe('license without orgs', () => {
    ...
    test('renders the no organization for this license message', () => {
      const { getByText } = renderComponent;
      expect(getByText('No organizations for this license'));
    });
  });
});
